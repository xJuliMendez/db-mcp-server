...
async function getInfoFromDockerByQuery(query) {
...
server.tool('getDatabaseInfo', 'Provide a query to get information from the database', { query: z.string() }, async ({ query }) => getInfoFromDockerByQuery(query));
